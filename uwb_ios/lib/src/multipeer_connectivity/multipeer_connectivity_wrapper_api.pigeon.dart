...
class MCSessionWrapper {
  ...
  Object encode() {
    final Map<Object?, Object?> pigeonMap = <Object?, Object?>{};
    pigeonMap['peerId'] = peerId == null ? null : peerId!.encode();
    pigeonMap['encryptionPreference'] = encryptionPreference == null ? null : encryptionPreference!.index;
    return pigeonMap;
  }
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_context != null, 'Argument for dev.flutter.pigeon.MCNearbyServiceAdvertiserDelegateFlutterApi.didReceiveInvitationFromPeer was null, expected non-null String.');
